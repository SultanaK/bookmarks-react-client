...
class AddBookmark extends Component {
    ...
    handleSubmit = e => {
        ...
        //url = 'https://thinkful-list-api.herokuapp.com/v3/bookmarks'
        ...
        const options = {
            ...
            headers: {
                ...
                "Authorization": "Bearer $2a$10$xdWT8yfK3SFtmIWpX3AMROPwL7VsLfKiAZxjMNuDBmdX5HkLgP4ce"
            }
        };
            ...
            <div className="addbookmark">
                ...
                <form className="addbookmark__form" onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" name="url" id="url" placeholder="url"
                        value={this.state.url} onChange={e => this.urlChanged(e.target.value)} />
                    <label htmlFor="description">Description:</label>
                    <textarea name="description" id="description" placeholder="description"
                        value={this.state.description} onChange={e => this.descriptionChanged(e.target.value)} />
